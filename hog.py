...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        y = previous_score
        if who == 0:
            current_score = score0 - y
            y = score0
        elif who == 1:
            current_score = score1 - y
            y = score1
        if current_score > x:
            if current_score == 1:
            ...
            x = current_score  
        return announce_highest(who, x, y)
    return say
    # END PROBLEM 7
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if score < opponent_score and is_swap(score, opponent_score):
        ...
        return 0
    elif not is_swap(score, opponent_score) and free_bacon(opponent_score) >= margin:
        return 0
    else: 
        return num_rolls
    # END PROBLEM 11
