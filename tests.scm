...
(define (f x) (define (x f) (define f x)))
; expect f
(f 1)
; expect x
(x f)
...
; expect (i will not be evaluated!)
...
(define val (begin (print 1) (define y 2) (+ 1 2)))
; expect 1 ; val
(+ val y)
; expect 5

(let ((a 1) (b 2)) (print (+ a b)) (define x 3) )
; expect 3 ; x
x
; expect Error
